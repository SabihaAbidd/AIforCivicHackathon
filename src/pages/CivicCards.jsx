...
const PAST_CARDS = [
  ...
  },
  {
    ...
    bg: '#7dbb8a',
    num: '96',
    fact: 'The Senate has 96 members representing all provinces equally.',
    date: 'Jun 7',
  },
]
    ...
    <div className="cards-page page-wrap">
      ...
      <section aria-labelledby="todays-card">
        ...
        <div className="daily-card-featured" id="featured-civic-card">
          ...
          <div className="daily-card-stat">72%</div>
          <p className="daily-card-fact">
            72% of Pakistan's population is under the age of 35 —
            making Gen Z and millennials the majority. <strong>Your vote shapes everything.</strong>
          </p>
          <p className="daily-card-source">Source: Pakistan Bureau of Statistics, 2023</p>
        </div>
